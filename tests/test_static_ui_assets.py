...
class StaticUiAssetTests(unittest.TestCase):
    ...
    def test_lobby_separates_stage_from_activity_feed(self):
        ...
        self.assertIn("if (state.liveAgentSmokeRunning || state.liveAgentReadinessRunning) return;", script)
        self.assertIn("state.liveAgentProcessesLoading || state.liveAgentSmokeRunning || state.liveAgentReadinessRunning", script)
