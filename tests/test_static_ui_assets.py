...
class StaticUiAssetTests(unittest.TestCase):
    ...
    def test_lobby_separates_stage_from_activity_feed(self):
        ...
        self.assertIn("state.liveAgentSessionRestartRunning || state.liveAgentSessionCheckRunning", script)
        ...
        self.assertIn("state.liveAgentReadinessRunning || Boolean(state.liveAgentProcessRowActionRunning)", script)
