...
class StaticUiAssetTests(unittest.TestCase):
    ...
    def test_lobby_separates_stage_from_activity_feed(self):
        ...
        self.assertIn("state.liveAgentProcessStartRunning || state.liveAgentSessionStartRunning", script)
        self.assertIn("state.liveAgentSessionStartRunning || state.liveAgentPreflightRunning", script)
        ...
        self.assertIn("agent_config_path: agentConfigPath", script)
