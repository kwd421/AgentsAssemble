...
class StaticUiAssetTests(unittest.TestCase):
    def test_react_default_surface_keeps_discord_room_shell(self):
        ...
        self.assertIn("openRoomSocket", app_source)
        self.assertNotIn("openGeneralRoomSocket", app_source)
        self.assertNotIn("export function openGeneralRoomSocket", api_source)
        self.assertNotIn('"/ws/rooms/general"', api_source)
        self.assertIn('op: "command"', api_source)
        self.assertIn('action: command.action', api_source)
        self.assertIn('streams, resume_from_seq: lastSeq', api_source)
        self.assertIn('new WebSocket(`${wsBaseUrl()}/ws?ticket=', api_source)
        self.assertIn('command("message.send"', api_source)
        self.assertIn('roomSocket.command("agent.create"', app_source)
        self.assertNotIn('postJson<AgentSessionActionResponse>("/api/agent-sessions"', api_source)
        self.assertNotIn('"/api/rooms/general/events"', api_source)
        self.assertNotIn('"/api/rooms/general/agents"', api_source)
        self.assertIn('openRoomSocket(auth, ["room_events", "side_chat"]', app_source)
        self.assertIn("onRoomSnapshot:", app_source)
        self.assertIn("onRoomEvents:", app_source)
        self.assertNotIn("subscribeRoomEvents(", app_source)
    ...
    def test_react_discord_home_friends_uses_persisted_room_friends(self):
        ...
        self.assertIn("export function loadHiddenRoomIds", room_dock_source)
        self.assertIn("export function persistHiddenRoomIds", room_dock_source)
        self.assertIn("persistHiddenRoomIds(next)", app_source)
        self.assertIn("사이드바에서 숨기기", room_rail_source)
    ...
    def test_react_live_tab_subscribes_to_meeting_sse_without_route_flip_or_provider_start(self):
        ...
        self.assertIn("() => roomEventsToTimelineEvents(activeRoomEvents)", app_source)
