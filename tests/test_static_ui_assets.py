...
class StaticUiAssetTests(unittest.TestCase):
    ...
    def test_lobby_separates_stage_from_activity_feed(self):
        ...
        self.assertIn("state.liveAgentProcessStartRunning || state.liveAgentPreflightRunning", script)
        ...
        self.assertIn('state.liveAgentProcessStatus = { message: `공식 라운드 smoke ${payload.status || "unknown"} · ${answered} answered, ${timedOut} timed out, ${skipped} skipped`, tone };', script)
