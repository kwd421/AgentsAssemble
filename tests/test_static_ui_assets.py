...
class StaticUiAssetTests(unittest.TestCase):
    def test_react_default_surface_keeps_discord_room_shell(self):
        ...
        self.assertIn("export const LIVE_CLI_ROOM", room_dock_source)
        self.assertIn('meetingId: "general"', room_dock_source)
        self.assertIn("LIVE_CLI_ROOM", app_source)
        self.assertIn("activeRoom.meetingId === LIVE_CLI_ROOM.meetingId", app_source)
        self.assertIn("meetingId: LIVE_CLI_ROOM.meetingId", app_source)
        self.assertIn("submitMessage={isLiveCliRoom && !guestLocked ? submitGeneralRoomMessage : undefined}", app_source)
        self.assertNotIn("meetingId: activeRoom.meetingId", app_source.split("function generalRoomEventToLobbyEvent", 1)[1].split("const submitGeneralRoomMessage", 1)[0])
        self.assertNotIn("submitMessage={!guestLocked ? submitGeneralRoomMessage : undefined}", app_source)
        ...
        self.assertIn("liveCliRoom?: boolean;", room_connection_source)
        self.assertIn("liveCliAgents?: GeneralRoomAgent[];", room_connection_source)
        self.assertIn("onLiveCliAgentControl?:", room_connection_source)
        self.assertIn("if (liveCliRoom) {", room_connection_source)
        self.assertIn("{!liveCliRoom && !guestLocked && (", room_connection_source)
        self.assertIn("onLiveCliAgentControl(agent, \"start\")", room_connection_source)
        ...
        self.assertIn("projectGeneralRoomTimeline", general_source)
        self.assertIn("finalTurnKeys", general_source)
        self.assertIn("streamingByTurnKey", general_source)
        self.assertIn("timelineEvents.map", general_source)
        self.assertIn("return filterLiveCliTerminalText(event.content);", general_source)
        self.assertNotIn("filterLiveCliTerminalText(event.content) || event.content", general_source)
    ...
    def test_react_side_chat_uses_separate_room_contract(self):
        ...
        self.assertIn('openRoomSocket(auth, ["lobby", "roster", "side_chat"]', app_source)
        self.assertIn("onSideChat: (incoming) =>", app_source)
    ...
    def test_react_discord_member_panel_uses_persisted_room_roles(self):
        ...
        self.assertIn("방 연결 정보", app_source)
        self.assertIn("Agent Session", room_connection_source)
        self.assertIn("PLAY_ACTIVITIES", room_connection_source)
    ...
    def test_react_lobby_flow_start_requests_unlimited_turn_budget(self):
        ...
        room_modes_source = room_panel_source[
            room_panel_source.index("const ROOM_FLOW_MODES") : room_panel_source.index("const PLAY_ACTIVITIES")
        ]
        ...
        self.assertNotIn("Round Robin", room_panel_source)
        self.assertNotIn("Free Interval", room_panel_source)
        self.assertNotIn("Quiet Call", room_panel_source)
        self.assertIn("flow_policy: selectedMode", room_panel_source)
        self.assertIn("max_agent_turns: 0", room_panel_source)
        self.assertIn("max_total_turns: 0", room_panel_source)

        self.assertNotIn("Mafia Night", room_modes_source)
        self.assertIn("const PLAY_ACTIVITIES", room_panel_source)
        self.assertIn("selectedActivityId", room_panel_source)
        self.assertIn("PLAY_ACTIVITIES.map", room_panel_source)
        self.assertIn("handleStartSelectedActivity", room_panel_source)
        self.assertIn("playErrorMessage", room_panel_source)
        self.assertIn("이 방은 아직 실행 가능한 회의 세션이 없습니다", room_panel_source)
        self.assertIn("handleStartConversation", room_panel_source)
        self.assertIn("Free/play flow is disabled. Use ordered Agent Sessions.", room_panel_source)
        self.assertIn("conversationFlowDisabled", room_panel_source)
        self.assertIn("handleStartMafia", room_panel_source)
        self.assertIn("Agent Session", room_panel_source)
        ...
        self.assertIn("Mafia Night", room_panel_source)
