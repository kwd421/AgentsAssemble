...
class StaticUiAssetTests(unittest.TestCase):
    ...
    def test_react_discord_home_friends_uses_persisted_room_friends(self):
        ...
        self.assertIn('onHomeClick={() => (guestLocked ? goToChannel("lobby") : goToChannel("friends"))}', app_source)
        ...
        self.assertIn("[inviteModalRoom.meetingId]: memberPayload.members || []", app_source)
