...
class StaticUiAssetTests(unittest.TestCase):
    ...
    def test_react_lobby_preserves_agent_owned_room_evidence(self):
        ...
        self.assertIn("baseline 호출형", member_source)
        self.assertIn("runtime-managed", member_source)
        self.assertIn("provider tool-loop", member_source)
        self.assertIn("Codex 5.3 Spark 실측은 4-6초", member_source)
        self.assertIn("exec/resume 호출 비용", member_source)
        self.assertIn("persistent bridge PoC", member_source)
    ...
    def test_react_room_messages_wrap_natural_language_without_truncating_body(self):
        ...
        lobby_body_class = lobby_source.split('<DiscordText text={event.message || ""} />')[0].rsplit('<div className="', 1)[1].split('">', 1)[0]
    ...
    def test_react_discord_member_panel_uses_persisted_room_roles(self):
        ...
        self.assertIn("방 연결 정보", app_source)
        self.assertIn("플레이 모드", room_connection_source)
    ...
    def test_react_lobby_message_actions_open_side_chat_thread_context(self):
        ...
        self.assertIn("function MessageRow({ event, onOpenSideThread, threadSummary, voteCard }", lobby_source)
    ...
    def test_react_lobby_prioritizes_chat_over_operator_cards(self):
        ...
        self.assertIn("visibleEvents.map((event, index) => {", lobby_source)
        self.assertIn("threadSummary={threadSummaries[event.id]}", lobby_source)
    ...
    def test_react_lobby_flow_start_requests_unlimited_turn_budget(self):
        ...
        self.assertIn("대화 방식", room_panel_source)
