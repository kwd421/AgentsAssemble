...
class FrontendRosterTruthTests(unittest.TestCase):
    ...
    def test_active_agent_session_room_events_feed_live_view_without_flow(self):
        ...
        self.assertIn("export function resumeAgentSession", api)
        self.assertIn("agentSessionProgress", live_view)
        self.assertIn("thinking/progress", live_view)
        self.assertIn("resumeAgentSession", room_connection)
        ...
        self.assertIn("agentSessionDiagnosticsSummary", room_connection)
        self.assertIn("<details", room_connection)
        self.assertIn("고급 진단", room_connection)
        self.assertIn("runtime mode", room_connection)
        self.assertIn("runtime profile", room_connection)
        self.assertIn("sharing policy", room_connection)
        self.assertIn("thread reused", room_connection)
        self.assertIn("first delta", room_connection)
        self.assertIn("turn completed", room_connection)
        self.assertIn("stderr", room_connection)
        self.assertIn("provider visible chars", room_connection)
        self.assertIn("context error", room_connection)
