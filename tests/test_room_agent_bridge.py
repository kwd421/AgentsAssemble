...
class RoomAgentBridgeTests(unittest.TestCase):
    ...
    def test_autonomous_room_wake_publishes_only_outbox_and_can_stay_silent(self):
        ...
        self.assertEqual(observed_reports, [{"through_seq": 1}, {"through_seq": 2}])
    ...
    def test_room_event_delivery_does_not_claim_provider_observation(self):
        client = FakeClient()
        runtime = FakeRuntime()
        bridge = RoomAgentBridge(
            client,
