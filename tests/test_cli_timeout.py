...
class CliTimeoutTests(unittest.TestCase):
    ...
    def test_frontend_info_prints_json_contract_without_starting_processes(self):
        ...
        self.assertEqual(payload["legacy_console_url"], "http://127.0.0.1:9999/legacy/")
        ...
        if payload["app_static_available"]:
            ...
            self.assertEqual(payload["recommended_ui_label"], "Legacy vanilla console")
            self.assertEqual(payload["default_console_kind"], "legacy_vanilla")
            self.assertEqual(payload["default_console_label"], "Legacy vanilla console (default until React build exists)")
    ...
    def test_frontend_info_reports_react_app_static_availability_from_dist(self):
        ...
        self.assertEqual(missing_payload["recommended_ui_label"], "Legacy vanilla console")
