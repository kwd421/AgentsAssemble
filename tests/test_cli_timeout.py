...
class CliTimeoutTests(unittest.TestCase):
    ...
    def test_frontend_info_prints_json_contract_without_starting_processes(self):
        ...
        self.assertEqual(payload["retired_legacy_paths"], ["/legacy/", "/legacy/static/*", "/static/*"])
        ...
        self.assertEqual(payload["react_app_label"], "React room client (default at /, alias at /app/)")
        self.assertEqual(payload["app_dist_path"], "frontend/dist")
        self.assertEqual(payload["integration_doc"], "docs/product/react-room-client-integration.md")
        ...
        if payload["app_static_available"]:
            ...
            self.assertEqual(payload["recommended_ui_label"], "React room client")
            self.assertEqual(payload["default_console_kind"], "react")
            self.assertEqual(payload["default_console_label"], "React room client (default entry point at /)")
            self.assertEqual(payload["app_build_status"], "available")
        else:
            self.assertEqual(payload["recommended_ui_kind"], "react_build_missing")
            self.assertEqual(payload["recommended_ui_label"], "React room client build missing")
            self.assertEqual(payload["default_console_kind"], "react_build_missing")
            self.assertEqual(payload["default_console_label"], "React room client (build required)")
        self.assertEqual(payload["integration_doc"], "docs/product/react-room-client-integration.md")
    ...
    def test_frontend_info_text_mode_presents_react_default(self):
        ...
        self.assertIn("React room client (default at /, alias at /app/): http://127.0.0.1:8765/app/", output)
        self.assertIn("React/Vite opt-in UI: http://127.0.0.1:5173", output)
        self.assertIn("Integration doc: docs/product/react-room-client-integration.md", output)
        self.assertIn("Retired legacy paths: /legacy/, /legacy/static/*, /static/*", output)
        self.assertIn("no vanilla fallback is served", output)
    ...
    def test_frontend_info_reports_react_app_static_availability_from_dist(self):
        ...
        self.assertEqual(missing_payload["recommended_ui_kind"], "react_build_missing")
        self.assertEqual(missing_payload["recommended_ui_url"], "http://127.0.0.1:9876/")
        self.assertEqual(missing_payload["recommended_ui_label"], "React room client build missing")
        ...
        self.assertEqual(incomplete_payload["recommended_ui_kind"], "react_build_missing")
        ...
        self.assertEqual(present_payload["recommended_ui_label"], "React room client")
