...
class RoomRealtimeControllerTests(
    ...
    def test_bridge_crash_restarts_once_with_room_memory_and_pending_diff(self):
        ...
        self.controller.bridge_process_exited("general", "codex", 17, "fatal provider stderr Authorization: Bearer bridge-stderr-secret")
        recovering = self.controller.store.session("general", "codex")
    ...
    def test_agent_create_registers_and_starts_native_cli_on_same_command_path(self):
        ...
        created_session = created["result"]["agent_session"]
        agent_id = created_session["session_id"]
