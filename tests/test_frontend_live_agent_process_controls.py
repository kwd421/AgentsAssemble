...
class FrontendLiveAgentProcessControlTests(unittest.TestCase):
    ...
    def test_member_and_friend_cards_use_single_agent_process_guard(self):
        ...
        self.assertIn("<AgentSessionDetails", member_source)
        self.assertIn("session={entry.agentSession}", member_source)
        self.assertIn("onControl={onAgentControl}", member_source)
