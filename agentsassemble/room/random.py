"""Validated server-side randomness for canonical room tools."""
...
def roll_dice(
    ...
    *,
    ...
    rolls = [int(randbelow(parsed.sides)) + 1 for _ in range(parsed.count)]
    return {
...
def choose_random(
    ...
    *,
    ...
    """Choose one item from a bounded non-empty list."""
