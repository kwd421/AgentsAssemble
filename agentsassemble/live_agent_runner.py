...
from agentsassemble.providers.grok_resident import default_grok_resident_command, grok_error_category
...
def _config_from_mapping(
    ...
    *,
    ...
    return ResidentAgentConfig(
        ...
        fast_mode=live_agent_bool(data.get("fast_mode"), False),
        reply_char_limit=max(0, int(data.get("reply_char_limit") or 0)),
        stream_thinking=live_agent_bool(data.get("stream_thinking"), False),
