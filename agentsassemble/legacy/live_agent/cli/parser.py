...
from agentsassemble.legacy.live_agent.cli.common import (
    ...
    add_session_auto_restart_args,
    add_session_finalize_after_rounds_arg,
    add_session_readiness_wait_args,
...
def register_live_agent_parsers(subparsers: argparse._SubParsersAction) -> None:
    ...
    add_session_finalize_after_rounds_arg(live_call_remaining_rounds)
    ...
    add_session_readiness_wait_args(live_start_session)
    add_session_auto_restart_args(live_start_session)
    ...
    add_session_finalize_after_rounds_arg(live_start_session)
    live_start_session.add_argument(
        "--probe-bound-agents",
        action="store_true",
    ...
    add_session_readiness_wait_args(live_resume_session)
    add_session_auto_restart_args(live_resume_session)
    ...
    add_session_finalize_after_rounds_arg(live_resume_session)
    live_resume_session.add_argument(
        "--probe-bound-agents",
        action="store_true",
        help="Before optional remaining rounds, require each bound live agent to answer a lobby probe.",
    ...
    add_session_readiness_wait_args(live_restart_session)
    ...
    add_session_finalize_after_rounds_arg(live_restart_session)
    live_restart_session.add_argument(
        "--probe-bound-agents",
        action="store_true",
        help="Before optional remaining rounds, require each bound live agent to answer a lobby probe.",
    ...
    add_session_readiness_wait_args(live_recover_session)
    ...
    add_session_finalize_after_rounds_arg(live_recover_session)
    live_recover_session.add_argument(
        "--probe-bound-agents",
        action="store_true",
        help="Before optional remaining rounds, require each bound live agent to answer a lobby probe.",
    ...
    add_session_auto_restart_args(live_ensure_session)
    ...
    add_session_finalize_after_rounds_arg(live_ensure_session)
    live_ensure_session.add_argument(
        "--probe-bound-agents",
        action="store_true",
        help="Before optional remaining rounds, require each bound live agent to answer a lobby probe.",
    ...
    add_session_auto_restart_args(live_auto_join)
    live_auto_join.add_argument(
        "--run-remaining-rounds",
        action="store_true",
        help="After the ensured session is ready, run remaining official template rounds.",
    ...
    add_session_finalize_after_rounds_arg(live_auto_join)
    live_auto_join.add_argument(
        "--probe-bound-agents",
        action="store_true",
        help="Before optional remaining rounds, require each bound live agent to answer a lobby probe.",
