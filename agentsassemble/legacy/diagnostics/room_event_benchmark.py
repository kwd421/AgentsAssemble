...
from agentsassemble.diagnostics.room_event_benchmark_contract import (
...
# first-speaker dominance by at least the shared health-report threshold. This
# is a regression tripwire, not a product fairness SLA.
