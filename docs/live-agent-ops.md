...
`provider_kind_mismatch` or `connection_kind_mismatch` attention instead of
repairing the roster row, rejecting permissive manual registration, or exposing
session ids, endpoints, auth refs, config paths, commands, prompts, logs, or
provider output.
