...
| `/api/meetings/{meeting_id}/workroom-queue` | GET | prefix | `fetchWorkroomQueueEvidence()` | yes | React Board workroom queue uses safe presence/count projection only. |
