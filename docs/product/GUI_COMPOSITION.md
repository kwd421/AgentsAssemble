...
| `features/side_chat/routes.py` | Active optional | Separate side-chat history and SSE; root compatibility export remains in `gui_side_chat_http.py` | `tests/test_frontend_side_chat_runtime.py`, `tests/test_gui_server_lobby_social.py` |
| `features/social/routes.py` | Active optional | Local profile, friends, and friend DM; root compatibility export remains in `gui_social_http.py` | `tests/test_gui_server_social_http.py`, `tests/test_room_social_flows.py` |
