...
| --- | --- | --- | --- |
| `legacy/gui_application.py` | Compatibility composition | Server-lifetime construction and registration bundle for retained meeting/live-agent routes; current `gui.py` injects patch seams and server-owned services; root module is a compatibility export | `tests/test_legacy_package.py`, route-family tests below |
