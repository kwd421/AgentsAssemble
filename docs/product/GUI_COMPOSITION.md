...
| `gui_legacy_live_agent_official_reply_http.py` | Compatibility | Verified resident official/review replies, idempotent append, official artifact/shared-memory refresh, heartbeat, and bounded audit; policy lives in `legacy/live_agent/official_reply.py` | `tests/test_gui_legacy_live_agent_official_reply_http.py`, `tests/test_legacy_live_agent_official_reply.py`, `tests/test_gui_server_moderation_finalization.py`, `tests/test_gui_server_turns.py` |
