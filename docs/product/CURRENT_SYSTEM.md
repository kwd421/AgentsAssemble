...
| Other provider process lifecycle | `providers/bridge_process.py`, `providers/agent_bridge.py`, `providers/live_cli.py`, provider adapter module; compatibility export in `room_bridge_process.py` |
