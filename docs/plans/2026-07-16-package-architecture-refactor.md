...
- 2026-07-20: The retained same-host self-managed resident stop/resume HTTP
  registrar moved mechanically to `legacy/live_agent/http/self_managed.py`.
  Legacy GUI composition imports the owned registrar directly; root
...
- 2026-07-20: The retained local resident CLI discovery HTTP registrar moved
  ...
  unchanged.
- 2026-07-20: The retained resident configuration-preflight HTTP registrar
  moved mechanically to `legacy/live_agent/http/preflight.py`. Legacy GUI
  composition imports the owned registrar directly; root
...
- 2026-07-20: The retained durable resident session-run control HTTP registrar
  moved mechanically to `legacy/live_agent/http/session_run.py`. Legacy GUI
  composition imports the owned registrar directly; root
  `gui_legacy_live_agent_session_run_http.py` remains a metadata-tracked
