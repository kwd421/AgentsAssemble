...
| Coherent commits exist | Branch contains focused commits for docs, event metadata, SSE streaming, GUI subscriptions, moderator turn control, streamed completion refresh, live-room UI feedback, and SSE heartbeat coverage. |
